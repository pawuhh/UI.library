...
function Library:Create(xHubName,xGameName)
    ...
    local xGameName = xGameName or "By ria"
    ...
    Filler.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
    ...
    function xTabs:Tab(Name,xVisible)
        ...
        function Elements:Button(Name,Callback)
            ...
            ButtonFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
        ...
        function Elements:Toggle(Name,Callback)
            ...
            ToggleFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
            ToggleFrame.BorderSizePixel = 0
            ToggleFrame.Size = UDim2.new(0, 408, 0, 35)

            ToggleName.Name = "ToggleName"
            ToggleName.Parent = ToggleFrame
            ToggleName.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
            ...
            ToggleF.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
            ...
            ToggleButton.MouseButton1Down:Connect(function()
                ...
                if ToggleEnabled then 
                    game:GetService("TweenService"):Create(ToggleF, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play() 
        ...
        function Elements:Slider(Name,Min,Max,Callback)
            ...
            SliderFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
            ...
            SliderTrail.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        function Elements:Textbox(Name,Default,Callback)
            ...
            TextboxFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
        ...
        function Elements:Keybind(Name,xKey,Callback)
            ...
            KeybindFrame.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
        ...
        function Elements:Dropdown(Name,Listx,Callback)
            ...
            DropList.BackgroundColor3 = Color3.fromRGB(47, 47, 47)
